...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
    peliculaLarga=mod.encontrar_pelicula_mas_larga(p1,p2,p3,p4)
    mostrar_informacion_pelicula(peliculaLarga)
   # TODO: Completar
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    duracion=mod.duracion_promedio_peliculas(p1,p2,p3,p4)
    print(duracion)
   # TODO: Completar
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio=int(input('Digite año de estreno: '))

    print('las peliculas son: '+ mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio))
   # TODO: Completar
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    porno=mod.cuantas_peliculas_18_mas(p1,p2,p3,p4,p5)
    print(porno)
   # TODO: Completar
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        nuevo_dia=input('Digite el nuevo dia: ')
        nueva_hora_str=input('Digite la nueva hora en formato "HH:MM": ')
        nueva_hora= (int(nueva_hora_str[:2])*100)+int(nueva_hora_str[3:])
        control_horario_str=input('digite "y" si desea tener en cuenta las preferencias de horario, de lo contrario digite "n": ')
        if control_horario_str=='y':
            control_horario=True
        else:
            control_horario=False
        pudo_reagendar=mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)
    
    if pudo_reagendar:
        print('La pelicula ',nombre,' fue reagendada para el ',nuevo_dia,' a las ',nueva_hora_str)
    else:
        print('La pelicula ', nombre, ' no pudo ser reagendada')
    # TODO: Completar
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        edad_invitado=int(input('Digite la edad del invitado: '))
        autorizacion_padres_str=input('digite "y" si el invitado tiene autorizacion de sus padres, de lo contrario digite "n": ')
        if autorizacion_padres_str=='y':
        ...
        if decidir_invitar:
             print('Si se puede invitar a ver la pelicula')
        else:
            print('No se puede invitar a ver la pelicula')
   # TODO: Completar
